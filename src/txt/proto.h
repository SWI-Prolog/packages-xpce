...
COMMON(status)	change_textbuffer(TextBuffer tb, intptr_t where, String s);
COMMON(status)	str_sub_text_buffer(TextBuffer tb, String s, intptr_t start, intptr_t len);
COMMON(status)	insert_textbuffer(TextBuffer tb, intptr_t where, intptr_t times, String s);
