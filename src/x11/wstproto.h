...
COMMON(void)	ws_draw_in_display(DisplayObj d, Graphical gr, BoolObj invert, BoolObj subtoo);
...
COMMON(status)	d_image(Image i, int x, int y, int w, int h);
COMMON(status)	d_screen(DisplayObj d);
COMMON(status)	d_frame(FrameObj fr, int x, int y, int w, int h);
...
COMMON(BoolObj)	r_subwindow_mode(BoolObj val);
COMMON(void)	r_invert_mode(BoolObj val);
COMMON(void)	r_translate(int x, int y, int *ox, int *oy);
COMMON(void)	r_box(int x, int y, int w, int h, int r, Any fill);
COMMON(void)	r_shadow_box(int x, int y, int w, int h, int r, int shadow, Any fill);
...
COMMON(void)	s_print(PceString s, int x, int y, FontObj f);
COMMON(void)	s_print_aligned(PceString s, int x, int y, FontObj f);
COMMON(void)	str_size(PceString s, FontObj font, int *width, int *height);
COMMON(void)	str_string(PceString s, FontObj font, int x, int y, int w, int h, Name hadjust, Name vadjust, int flags);
COMMON(void)	str_selected_string(PceString s, FontObj font, int f, int t, Style style, int x, int y, int w, int h, Name hadjust, Name vadjust);
COMMON(void)	ps_string(PceString s, FontObj font, int x, int y, int w, Name format, int flags);
COMMON(void)	str_label(PceString s, int acc, FontObj font, int x, int y, int w, int h, Name hadjust, Name vadjust, int flags);
